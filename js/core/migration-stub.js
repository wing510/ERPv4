...
(function () {
  ...
  var MIGRATED_TABLES = {
    ...
    commercial_dealer_level_post: 1,
    dealer_cumulative_ledger: 1,
    ar_receivable: 1,
    ar_payment: 1,
  ...
  var MODULE_TABLES = {
    ...
    sales: ["sales_order", "sales_order_item", "so_item_pricing_snapshot", "customer", "product"],
    ...
    dealer_rebate: ["commercial_dealer_monthly_stat", "commercial_dealer_level_post", "commercial_dealer_rebate", "dealer_cumulative_ledger", "customer", "consignment_case_settlement", "ar_receivable"],
    ...
    shipping: ["shipment", "shipment_item", "sales_order", "sales_order_item", "so_item_pricing_snapshot", "lot", "customer", "customer_recipient", "product", "commercial_invoice", "commercial_invoice_line", "einvoice_line", "erp_company_profile", "consignment_case"],
  ...
  var TABLE_ZH = {
    ...
    commercial_dealer_level_post: "經銷等級過帳紀錄",
    dealer_cumulative_ledger: "經銷累積分類帳",
    ar_receivable: "應收帳款",
    ar_payment: "收款紀錄",
